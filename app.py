...
st.markdown("""
Welcome to the clinical deployment prototype. This tool utilizes the optimized **CatBoost architecture** to predict the probability of stenosis based on Transcranial Doppler (TCD) hemodynamics across **8 arterial segments**.
""")
...
if models_loaded:
    ...
    # Hemodynamics
    # UPDATED: Added PCA segments
    vessel_options = [
        'L-MCA', 'R-MCA', 'L-ACA', 'R-ACA', 'L-VA', 'R-VA', 'BA', 
        'L-OA', 'R-OA', 'L-Siphon', 'R-Siphon', 'L-ICA', 'R-ICA', 'L-PCA', 'R-PCA'
    ]
    ...
    if st.sidebar.button("Run AI Diagnostics", type="primary"):
        ...
        st.write(f"The model's assessment was primarily influenced by **{top_feature}**. This marker contributed most significantly to the final classification of {prediction_label} (where 1 is Abnormal/Stenosis).")